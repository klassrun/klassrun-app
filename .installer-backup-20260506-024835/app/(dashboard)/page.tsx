...
//
// Authenticated dashboard for SCHOOL_ADMIN and TEACHER users.
// Editorial layout with school name as a "masthead" sidebar.
...
async function getCurrentUser(): Promise<MeResponse['user'] | null> {
    ...
    <div className="min-h-screen bg-paper text-foreground">
      ...
      <div className="mx-auto grid max-w-7xl grid-cols-1 gap-12 px-6 py-12 sm:px-8 lg:grid-cols-[260px_1fr] lg:py-16">
          ...
          <div className="mt-5 space-y-3 text-sm">
            ...
            {session && (
              <>
                ...
                <StatusRow
                  label="Term"
                  value={titleCase(session.currentTerm)}
                />
              </>
            )}
            <StatusRow
        ...
        <main className="min-w-0">
          ...
          {/* Onboarding checklist as numbered list */}
